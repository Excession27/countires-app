      ...
      <div className="card__info">
        ...
        <div className="card__stats-cont">
          ...
          <p className="card__stats-cont__lang">
            Languages:{" "}
            {prop.data.languages
              ? Object.values(prop.data.languages).reduce(
